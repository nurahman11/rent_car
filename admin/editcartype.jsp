    ...
    <div class="container">
    	<div class="row">
        	<div class="col-md-12">
                ...
                <form class="form-horizontal" action="doeditcartype.jsp" method="post" id="frmSignUp" autocomplete="off">
                	<%
						String query = "SELECT * FROM MsJenisKendaraan WHERE kode_jenis_kendaraan = '"+request.getParameter("car")+"'";
						ResultSet rs_car = st.executeQuery(query);
						if(rs_car.next()){
							String kode_car = rs_car.getString("kode_jenis_kendaraan");
					%>
                	...
                	<div class="form-group">
                        ...
                        <div class="col-sm-6">
	                        <input type="text" value="<%=rs_car.getString("nama_jenis_kendaraan")%>" id="car_name" name="car_name" class="form-control" placeholder="Enter car name..." />
                        </div>
                    </div>
                    <div class="form-group">
